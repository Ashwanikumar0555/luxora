...
//     <div className="container mx-auto flex-col md:flex-row gap-8 ">
  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        {/* Women's Collection */}
        <div className="relative flex-1">
          <img src={womensCollectionImage} alt="Women's Collection" className="w-full h-[700px] object-cover rounded-lg" />
        ...
        {/* Men's Collection */}
        <div className="relative flex-1">
          <img src={mensCollectionImage} alt="Men's Collection" className="w-full h-[700px] object-cover rounded-lg" />
          <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-4 rounded-lg">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">
              Men's Collection
            </h2>
